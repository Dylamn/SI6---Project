    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-responsive" src="images/logo_bde.png">
            </div>
            <div class="col-md-6">
                <div class="lp-element">
                    <h1>Bureau Des Étudiants<br><span class="lighter">Lycée de La Salle</span></h1>
                    <p class="lead">
                        <?php
...
<!-- La balise script permet d'intégrer du code JavaScript dans une page hmtl -->
<script>
