    										                 ...
    										                 <form method="post">                
    										                 	<div class="row">                    
    										                 		<div class="col-lg-12">                        
    										                 			...
    										                 			<div class="row">                    
    										                 				<div class="col-lg-12">                        
    										                 					<input class="form-control" type="text" placeholder="Hashtag | Exemple : #bde #etudiant #lycéedelasalle" name="hashtag">                    
    										                 					</div>                
    										                 				</div><br>                
    										                 				<div class="row">                    
    										                 					<div class="col-lg-12">                        
    										                 						<input class="form-control" type="text" placeholder="Votre classe" name="classe" maxlength="255">                    
    										                 						</div>                
    										                 						</div><br>                
    										                 						<input class="form-control" type="hidden" value="<?php echo $_SESSION['prenom'].' '.$_SESSION['nom'] ?>" name="auteur" maxlength="255">                
    										                 						<div class="row">                    
    										                 							<div class="col-lg-12">                        
    										                 								...
    										                 								<?php        }       
    										                 									...
    										                 									<div class="panel panel-danger">                
    										                 										...
    										                 										<div class="panel-body">                    Connectez-vous pour accéder à votre compte. Si vous n'avez pas encore de compte, vous pouvez dès à présent vous inscrire !<br><br><br>                  
