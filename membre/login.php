            ...
            <div class="row"><br>
                <div class="col-xs-12">
                    <div class="row">
                        ...
                        <form action="loginok.php" name="login" role="form" class="form-horizontal" method="post"
                              accept-charset="utf-8">
                            <h2><b>Vous êtes étudiants au Lycée de la Salle ?</b></h2>
                            <h3>Accèdez à votre compte avec vos identifiants !</h3>

                            <div class="form-group">
                                <div class="col-md-8"><input class="form-control" type="text" placeholder="Identifiant"
                                                             name="identifiant"></div>
                            </div>

                            <div class="form-group">
                                <div class="col-md-8"><input class="form-control" type="password"
                                                             placeholder="Mot de passe" name="mdp"></div>
                            </div>
